...
/* Below is a classic font array ; each ascii character is comprised of 40    */
/* pixels. Those pixels are arranged as 5 columns and 8 rows. Each 5 elements */
/* of the array represent a column. And from the value of the array element   */
/* char reading/writing code is supposed to derive 8 rows situation; if they  */
/* are to be colored or keep background color*/
/*         ----- ----- ----- ----- -----                                              */
/*        |     |     |*****|     |     |                                             */
/*        |C0-R0|C1-R0|C2-R0|C3-R0|C4-R0|           (C0-R0=Column0-Row0)              */
/*        |     |     |*****|     |     | In order to write a "1" on to the display   */
/*         -----  ---- ----- ----- -----  char writing code must call 5 proper ele-   */
/*        |     |*****|*****|     |     | ments of array. And then must decide which  */
/*        |C0-R1|C1-R1|C2-R1|C3-R1|C4-R1| pixels must be colored and which must pre-  */
/*        |     |*****|*****|     |     | serve background color.                     */
/*         -----  ---- ----- ----- -----  In order to write a "1" C1-R1,C1-R6,C2-R0~6 */
/*        |     |     |*****|     |     | and C3-R6 pixels must be colored others must*/
/*        |C0-R2|C1-R2|C2-R2|C3-R2|C4-R2| keep their background colors.               */
/*        |     |     |*****|     |     |                                             */
/*         -----  ---- ----- ----- -----                                              */
/*        |     |     |*****|     |     |                                             */
...
/*         -----  ---- ----- ----- -----                                              */
/*        |     |     |*****|     |     |                                             */
/*        |C0-R5|C1-R5|C2-R5|C3-R5|C4-R5|                                             */
/*        |     |     |*****|     |     |                                             */
/*         -----  ---- ----- ----- -----                                              */
/*        |     |*****|*****|*****|     |                                             */
/*        |C0-R6|C1-R6|C2-R6|C3-R6|C4-R6|                                             */
/*        |     |*****|*****|*****|     |                                             */
/*         -----  ---- ----- ----- -----                                              */
/*        |     |     |     |     |     |                                             */
/*        |C0-R7|C1-R7|C2-R7|C3-R7|C4-R7|                                             */
/*        |     |     |     |     |     |                                             */
/*         -----  ---- ----- ----- -----                                              */
